...
```{r Correlogram, echo=FALSE,fig.width=15, fig.height=10}
df <- raw_data %>%
...
```{r Milk price distribution, echo=FALSE}
...
```{r Total production movement, echo=FALSE}
...
```{r Total production movement faceted, echo=FALSE}
